...
const data = await page.evaluate(() => (/* 由 prepare_capture.py 绑定测量基线。只读取主文档，不导航、不操作页面。 */
(plan) => {
...
)({"measurement_sha256": "20d8d471498b37c1b1e3c4d59fb647a52c10bb0c10c99544191b612fc0957754", "targets": [{"name": "sidebar", "selector": ".workspace-sider"}, {"name": "header", "selector": ".workspace-header"}, {"name": "contract-heading", "selector": ".business-page-heading"}, {"name": "contract-facts", "selector": ".contract-workspace > .business-facts"}, {"name": "contract-nodes", "selector": ".contract-workspace .business-split > .business-stack:first-child > .business-panel:first-child"}, {"name": "contract-files", "selector": ".contract-workspace .business-split > .business-stack:first-child > .business-panel:nth-child(2)"}, {"name": "archive-progress", "selector": ".contract-workspace .business-split > .business-stack:nth-child(2) > .business-panel:first-child"}]}));
await page.screenshot({path:"/Volumes/WorkSpace/winh-ai-workplan/outputs/design/wi-009/calibration-round-1/candidate.png",fullPage:false,scale:"css",animations:"disabled"});
return {...data, full_page:false, screenshot_scale:"css"};
}