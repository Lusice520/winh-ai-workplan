async page => {
await page.setViewportSize({width:1505,height:1045});await page.evaluate(async()=>{window.scrollTo(0,0);await document.fonts.ready;});
...
await page.screenshot({path:"/Volumes/WorkSpace/winh-ai-workplan/outputs/design/wi-009/handover-calibration-round-2/candidate.png",fullPage:false,scale:"css",animations:"disabled"});return {...data,full_page:false,screenshot_scale:"css"};}